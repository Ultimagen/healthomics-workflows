...
<p name="SomaticFeaturemap.memory_gb_ScoreSomaticVariants">
        <b>SomaticFeaturemap.memory_gb_ScoreSomaticVariants</b><br />
        <i>Int? </i> &mdash;
         Memory in GB for ScoreSomaticVariants task. <br />
</p>
