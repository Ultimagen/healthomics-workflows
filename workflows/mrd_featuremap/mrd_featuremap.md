...
<p name="MRDFeatureMap.srsnv_test_X">
        <b>MRDFeatureMap.srsnv_test_X</b><br />
        <i>File </i> &mdash; 
         Parquet file of test set X matrix (SNV features) generated by the SingleReadSNV pipeline <br /> 
</p>
<p name="MRDFeatureMap.srsnv_test_y">
        <b>MRDFeatureMap.srsnv_test_y</b><br />
        <i>File </i> &mdash; 
         Parquet file of test set y vector (true/false values) generated by the SingleReadSNV pipeline <br /> 
</p>
<p name="MRDFeatureMap.srsnv_qual_test">
        <b>MRDFeatureMap.srsnv_qual_test</b><br />
        <i>File </i> &mdash; 
         Parquet file of test set SNVQ values generated by the SingleReadSNV pipeline <br /> 
</p>
