...
workflow MRDFeatureMap {
    input {
        ...
        #@wv suffix(srsnv_test_X) in {'.parquet'}
        #@wv suffix(srsnv_test_y) in {'.parquet'}
        #@wv suffix(srsnv_qual_test) in {'.parquet'}
    }
  ...
  parameter_meta {
      ...
      srsnv_test_X: {
          help: "Parquet file of test set X matrix (SNV features) generated by the SingleReadSNV pipeline",
          type: "File",
          category: "input_required"
      }
      srsnv_test_y: {
          help: "Parquet file of test set y vector (true/false values) generated by the SingleReadSNV pipeline",
          type: "File",
          category: "input_required"
      }
      srsnv_qual_test: {
          help: "Parquet file of test set SNVQ values generated by the SingleReadSNV pipeline",
          type: "File",
          category: "input_required"
      }
      cfdna_cram_bam: {
  ...
  call UGMrdTasks.MrdDataAnalysis as MrdDataAnalysis{
    input:
      ...
      srsnv_test_X = srsnv_test_X,
      srsnv_test_y = srsnv_test_y,
