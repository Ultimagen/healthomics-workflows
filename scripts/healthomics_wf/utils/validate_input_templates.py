...
from modules.s3_validation import get_unsigned_s3_client, is_s3_path, s3_path_exists
...
if __name__ == "__main__":
    ...
    input_templates = glob.glob("workflows/*/input_templates/*.json", recursive=True)
